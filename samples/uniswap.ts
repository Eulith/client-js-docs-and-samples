...
async function bestPrice() {
  ...
  await sellToken.approve(agentContractAddress, sellToken.asTokenValue(sellAmount + addALittleForFees),
    {
      from: acct.address
    })
  ...
  console.log(
    `After swap: fundingContract DELTA: ${
      ...
      sellToken.symbol
    }, and toolkit contract's balance DELTA (how much we added) in the transaction: ${
